...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.likecoin
    BOOST_LIB_SUFFIX=-mt
...
contains(LIKE_NEED_QT_PLUGINS, 1) {
    DEFINES += LIKE_NEED_QT_PLUGINS
...
# also add new translations to like.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/likeclient*.ts)
...
macx:ICON = src/qt/res/icons/like.icns
macx:TARGET = "LikeClient"
