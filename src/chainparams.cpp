...
int64_t CChainParams::GetProofOfWorkReward(int nHeight, int64_t nFees) const
{
    ...
    int64_t nSubsidy = 0;
    if(nHeight <= 100)
                nSubsidy = (NetworkID() == CChainParams::TESTNET ? 100000 : 40000000) * COIN;  // 4 Bil on MainNet
...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "www.nytimes.com/2017/09/13/upshot/the-economic-case-for-letting-teenagers-sleep-a-little-later.html";
        CTransaction txNew;
        ...
        vSeeds.push_back(CDNSSeedData("seed2.likecoin.me", "seed2.likecoin.me"));
        vSeeds.push_back(CDNSSeedData("seed3.likecoin.me", "seed3.likecoin.me"));
        vSeeds.push_back(CDNSSeedData("seed4.likecoin.me", "seed4.likecoin.me"));
        vSeeds.push_back(CDNSSeedData("likecoin.me",  "seed.likecoin.me"));
    }
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("031d3afff92b2d59943e57aaa8b1adbb110ff215fc4ebdc6fb5c9a797e2b1dea527");
        ...
        nLastPOWBlock = 50000;
        nFirstPosv2Block = 50001;
        nFirstPosv3Block = 50010;
        ...
        genesis.nNonce   = 747043;
        hashGenesisBlock = genesis.GetHash();
          
        assert(hashGenesisBlock == uint256("0x0000010ef6f2d3f7a55cb945e34e15cdbf2d10724deed620bee024a6465d0b46"));
        assert(genesis.hashMerkleRoot == uint256("0xa1a9bcef1c6baf718c265f475062b37d203b719c06267625aa31e13255303f5a"));

        base58Prefixes[PUBKEY_ADDRESS]      = list_of(48).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 10873;
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x0000d49dafb5f0bb226b78575280bf7823f095a7147b9da3cb9a2920d94b8e4e"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0x5663f28797ea92d92aee44b010ca0f629e7289ca037c1484ba72827e85f79dc0"));
