...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::LIKE).toInt();
    ...
    fAutoRedeemLike = settings.value("fAutoRedeemLike", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemLike: return "AutoRedeemLike";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::LIKE).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemLike: {
            fAutoRedeemLike = value.toBool();
            settings.setValue("fAutoRedeemLike", fAutoRedeemLike);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemLike() { return fAutoRedeemLike; }
