...
/**
  Like GUI main class. This class represents the main window of the Like UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class LikeGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit LikeGUI(QWidget *parent = 0);
    ~LikeGUI();
